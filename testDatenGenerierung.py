...
class ReinforcementLearningTestDaten(object):
    ...
    # Prüft auf gleichheit in den Vectoren 0 - 8
    ...
    def writeData(self):
        ...
        plt.xlabel("Runden mit je 100 Spiele")
        plt.ylabel("% gewinn chance")
        plt.title("Überblick mit Lernrrate 0.1")
        plt.grid()
